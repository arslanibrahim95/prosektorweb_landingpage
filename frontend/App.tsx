  ...
  return (
    <form onSubmit={submit} className="space-y-12 animate-in fade-in slide-in-from-bottom duration-500">
      ...
      <div className="space-y-8 max-w-lg mx-auto">
        ...
        <button type="submit" disabled={loading} className={`w-full bg-white text-black py-5 rounded-full text-2xl font-black shadow-2xl transition-all ${loading ? 'opacity-70' : 'hover:scale-105'}`}>

            ...
            <section id="contact" className="py-24 px-4">
                <div className="max-w-2xl mx-auto text-center">
                    <div className="glass rounded-3xl p-12 scale-in">
                        ...
                        <p className="text-gray-400 text-lg">En kısa sürede sizinle iletişime geçeceğiz.</p>
                    </div>
                </div>
            </section>
        );
                    ...
                    <div className="relative glass rounded-3xl p-8 md:p-12">
                        ...
                        <div className="mt-10 pt-8 border-t border-white/10 grid md:grid-cols-3 gap-6">
                            <div className="flex flex-col items-center gap-3 group">
                                ...
                                <span className="text-gray-400 text-sm group-hover:text-white transition-colors">hello@prosektorweb.com</span>
                            </div>
                            ...
                            <a href={WHATSAPP_LINK} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-3 group">
                                ...
                                <span className="text-gray-400 text-sm group-hover:text-white transition-colors">WhatsApp ile ulaşın</span>
                            </a>
                            ...
                            <div className="flex flex-col items-center gap-3 group">
                                ...
                                <span className="text-gray-400 text-sm group-hover:text-white transition-colors">24-72 saat içinde dönüş</span>
                            </div>
                        </div>
                    </div>
                </div>
